						  ...
						  <div class="card mb-4 py-3 border-left-primary">
				            <div class="card-body">
				              <div class="d-sm-flex align-items-center justify-content-between mb-4">
				                <h1 class="h3 mb-0 text-gray-800">Selamat Datang di Aplikasi Restaurant</h1>
				              </div>
				            </div>
				          </div>
                  <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
                    <a href="#" class="thumbnail">
                      <h2 align="center"><img src="<?=base_url()?>assets/img/rest.jpg" alt="foto" style ="width: 900px; height: 500px;" ></h2>
                    </a>
