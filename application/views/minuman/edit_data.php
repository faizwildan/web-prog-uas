    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
            <form action="<?=base_url()?>index.php/Minuman/updatedata" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control"  style="background-color: white;" name="jenis_kategori"  value="<?=$data->jenis_kategori?>">
            </div>
             <div class="form-group">
              <label class="control-label"> Stok </label>
              <input type="text" class="form-control"  style="background-color: white;" name="stok"  value="<?=$data->stok?>">
            </div>
