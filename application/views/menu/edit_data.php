    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
            <form action="<?=base_url()?>index.php/Menu/updatedata" method="post" enctype="multipart/form-data">
            <div class="form-group">
              
            <div class="form-group">
              <label class="control-label">Kode Menu</label>
              <input type="number" name="kode_menu" value="<?=$data->kode_menu?>" class="form-control">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" name="harga_menu" value="<?=$data->harga_menu?>" class="form-control">
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="status_menu" required>
