      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
            <form action="<?=base_url()?>index.php/Menu/insertdata" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label class="control-label"> Kode Menu </label>
              <input type="number" class="form-control"  style="background-color: white;" name="kode_menu" required>
            </div>
            <div class="form-group">
              <label class="control-label"> Nama Menu </label>
              <input type="text" class="form-control"  style="background-color: white;" name="nama_menu" required>
            </div>
            <div class="form-group">
              <label class="control-label"> harga Menu </label>
              <input type="number" class="form-control"  style="background-color: white;" name="harga_menu" required>
            </div>
            <div class="form-group">
              <label class="control-label"> Foto </label>
              <input type="file" class="form-control"  style="background-color: white;" name="fotopost" required>
            </div>

            <div class="form-group">
              <label class="control-label"> Status  </label>
              <select class="form-control" name="status_menu">
                <option>Status Makanan</option>
                <option>Tersedia</option>
                <option>Tidak</option>
              </select>
            </div>
            <div class="form-group">
              <label class="control-label"> Jenis Minuman  </label>
